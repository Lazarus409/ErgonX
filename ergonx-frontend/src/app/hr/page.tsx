...
const areas = [
  ...
  { title: "Departments", description: "Review the institution's department catalogue.", href: "/hr/departments", icon: Building2, permission: "organization.view" },
  { title: "Positions", description: "Review positions and their assigned department references.", href: "/hr/positions", icon: UserRoundCog, permission: "organization.view" },
  { title: "Grades", description: "Review grade definitions maintained for this institution.", href: "/hr/grades", icon: GraduationCap, permission: "organization.view" },
  { title: "Locations", description: "Review work locations, remote status, and locale details.", href: "/hr/locations", icon: MapPin, permission: "organization.view" },
];
