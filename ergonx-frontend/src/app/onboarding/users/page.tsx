...
export default function OnboardingUsersPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="rounded-3xl bg-slate-950 p-6 text-white shadow-[0_20px_50px_rgba(15,23,42,0.16)] sm:p-8"><p className="text-xs font-bold uppercase tracking-[0.14em] text-sky-300">Setup owners</p><h1 className="mt-2 text-3xl font-semibold tracking-tight">Invite your implementation team</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">During onboarding, active members remain read-only. Full access management moves to Settings after setup.</p></section>
