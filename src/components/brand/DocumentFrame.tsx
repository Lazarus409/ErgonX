 ...
 * The institution is the primary identity; ErgonX appears only as a
 * monochrome attribution, per branding.md. Prints cleanly: the application
 * shell is hidden and the document keeps neutral ink.
 */
export default function DocumentFrame({ institutionName, documentTitle, meta, children, footerNote, className }: { institutionName: string; documentTitle: string; meta?: ReactNode; children: ReactNode; footerNote?: ReactNode; className?: string }) {
  return (
